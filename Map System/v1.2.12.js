$(document).ready(function () {
    ...
    const renderMap = () => {
      ...
      function createPopUp(currentFeature) {
        ...
        document.getElementById('card_link-block').appendChild(mapCard.cloneNode(true));
        ...
        const popup = new mapboxgl.Popup({ closeOnClick: true })
          ...
          .setHTML(
            `<a id="card_link-block" href="${currentFeature.properties.link}" style="text-decoration: none;" ><h3>${currentFeature.properties.title} WHYYYY</h3><img loading="lazy" class="popup_img" alt src="${currentFeature.properties.imgURL}" ></a>`
          )
          .addTo(map);
      }
