    ...
    const renderMap = () => {
      ...
      function createPopUp(currentFeature) {
        ...
        const popup = new mapboxgl.Popup({ closeOnClick: true })
          ...
          .setHTML(
            `<a id="card_link-block" href="${currentFeature.properties.link}" style="text-decoration: none;" ><h3>${currentFeature.properties.title}</h3><img loading="lazy" class="popup_img" alt src="${currentFeature.properties.imgURL}" ></a>`
          )
          .addTo(map);
      }
